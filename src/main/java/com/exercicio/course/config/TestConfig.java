...
import com.exercicio.course.entities.enuns.OrderStatus;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o2 = new Order(null, Instant.parse("2021-08-20T19:03:15Z"), OrderStatus.WATTING_PAYMENT, u2);
		Order o3 = new Order(null, Instant.parse("2021-10-20T19:10:02Z"), OrderStatus.WATTING_PAYMENT, u1);
